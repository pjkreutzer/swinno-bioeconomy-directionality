...
display(
    Markdown(
        f"<span class='text-primary' style='font-size:15rem; font-weight:900'>{n_certain_bioeconomy_visions}</span>"
    )
)
...
### [No Bioeconomy]{.text-gray-600}, [Bioecology]{style="color:#cc78bc;"}, [Bioresource]{style="color:#de8f05;"} and [Biotechnoloy]{style="color:#029e73;"}{.smaller}

```{python}
# | label: fig-bv_trends
# | fig-cap: '[No Bioeconomy]{.text-gray-600}, [Bioecology]{style="color:#cc78bc;"}, [Bioresource]{style="color:#de8f05;"} and [Biotechnoloy]{style="color:#029e73"}'
...
def plot_bv_trends_interactive(df):
    ...
    fig.update_layout(showlegend=False, hovermode="x unified", height=550)
    fig.show()


plot_bv_trends_interactive(count_certain_bioeconomy_visions)
