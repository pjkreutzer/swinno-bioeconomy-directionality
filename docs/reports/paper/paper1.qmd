...
display(
    Markdown(
        f"@fig-bioeconomy_share shows the count (a) and share relative to all innovation contained in SWINNO (b) of bioeconomy innovation by year and as five year moving averages. From visual inspection alone, two features of the forest based bioeconomy innovation system emerge. First, two periods of high output can be identified from 1970-1990 and from 2005 to approximately 2015. The period in between 1990 and 2005 is characterized by low average output with high volatility. Second, the forest based bioeconomy has failed to gain in importance relative to other innovation captures by SWINNO. From a high of {share_max:.2%} in {share_max_year} to {share_latest:.2%} in {share_last_year}."
    )
)
