...
`{python} n_total_query` innovation were identified from the query. 
...
In later manual review of each innovation for classification these false positives were removed from the search results, yielding `{python} n_bioeconomy_innovation` innovations.
