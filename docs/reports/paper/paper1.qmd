...
WHERE
    (
        us.use_sectors LIKE '02%' -- Forestry and related services
-- Furniture manufacturing; other manufacturing
        OR us.use_sectors LIKE '20%' -- Wood and wood product manufacturing except furniture
        OR us.use_sectors LIKE '21%' -- Pulp, paper and paper product manufacturing
        OR us.use_sectors LIKE '36%' -- Furniture manufacturing; other manufacturing
        us.use_sectors LIKE '02%' -- Forestry and related services
-- Furniture manufacturing; other manufacturing
        OR product_code LIKE '20%' -- Wood and wood product manufacturing except furniture
        OR product_code LIKE '21%' -- Pulp, paper and paper product manufacturing
        OR product_code LIKE '36%' -- Furniture manufacturing; other manufacturing
    )
    OR (
        description LIKE '%virke%'
        OR description LIKE '%cellulos%'
