...
display(
    Markdown(
        f"### SWINNO -- A Swedish Innovation Output Database with {n_swinno} Innovations"
    )
)
...
[@sjoo2014DatabaseSwedishInnovations]{.slide-cite}
...
###  Uncleaned [5 Year MA]{.text-royal-blue-800} and [Yearly]{.text-gray-600}
...
display(
    Markdown(
        f"{sum_bioeconomy_innovations}{{.text-royal-blue-400}} Total Innovations in Forest Bioeconomy (Uncleaned)"
    )
)
...
|  | [Biotechnology]{.text-colorblind-green} | [Bioresource]{.text-colorblind-orange} | [Bioecology]{.text-colorblind-purple} |
|---|---|---|---|
...
|  | [Type II]{.text-colorblind-green} | [Type III]{.text-colorblind-orange} | [Type I]{.text-colorblind-purple} |
|---|---|---|---|
...
| | The cell is a factory | Biorefining at the heart of ecological transition (multilevel perspective). | Counter-expertise rather than concrete technical solutions <br> Criticism from  social groups who remain at the margins of decisionmaking centers |
:  {.small}

# Preliminary Results {.inverted}
...
text = f"""<span class="r-fit-text">after<b> {n_certain_bioeconomy_visions}</b> unique forest innovations classified</span>"""
...
::: notes
39 innovations involving either a product or process innovation related to recyling. Hence, 22 innovation are associated with the bioecology vision, without using or facilitating recycling.
:::
