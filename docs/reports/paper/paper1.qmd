...
In a report commissioned by the Swedish Government, the @research2012StrategyBiobasedEconomy defines a vision of a Swedish bioeconomy based on two central pillars.
...
The term bioeoconomics which they label as Type I bioeconomy, was introduced by Georgescu-Roegen,  in -@roegen1975BioeconomicAspectsEntropy.
@vivien2019HijackingBioeconomy argue that the term biotechnology gradually emerged between 1990 and 2000, in the wake of enthusiasm about biotechnological adavances, such as the discovery of DNA, in preceeding years.
It gained in popularity and international importance when the OECD began increasingly supporting and reshaping its meaning at the turn of the millenium [@vivien2019HijackingBioeconomy].
According to them the last concept to enter the discourse was the bioresource oriented bioeconomy.
While biomass has been used throughout history in various ways, the renewed interest with the intention to replace fossil inputs, for example in European Comission communication since 2010.
...
It is also classified as a biotechnology innovation since the process mimics trees' microfiber formation, according to the innovation source article.
...
An illustrative example of such an innovation are improved work boots, which promote safety of forest workers.
